...
namespace Serilog.Sinks.ElasticEcsLogstash.Private.Sinks
{
    ...
    public class TimeRolledDurableElasticEcsLogstashSink : ILogEventSink, IDisposable
    {
        private readonly HttpLogShipper shipper;
        private readonly ILogEventSink sink;

        /// <summary>
        /// Initializes a new instance of the <see cref="TimeRolledDurableElasticEcsLogstashSink"/> class.
        /// </summary>
        public TimeRolledDurableElasticEcsLogstashSink(
            string requestUri,
