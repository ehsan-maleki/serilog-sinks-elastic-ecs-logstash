...
using Serilog.Sinks.ElasticEcsLogstash.Private.IO;
...
namespace Serilog.Sinks.ElasticEcsLogstash.Private.Sinks
{
    ...
    public class FileSizeRolledDurableElasticEcsLogstashSink : ILogEventSink, IDisposable
    {
        private readonly HttpLogShipper shipper;
        private readonly ILogEventSink sink;

        /// <summary>
        /// Initializes a new instance of the <see cref="FileSizeRolledDurableElasticEcsLogstashSink"/> class.
        /// </summary>
        public FileSizeRolledDurableElasticEcsLogstashSink(
            string requestUri,
