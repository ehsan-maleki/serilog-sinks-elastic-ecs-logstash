...
{
    [RoutePrefix("warning-log")]
    public class WarningLogController : Controller
    {
        private readonly ILogProvider _logProvider;

        public WarningLogController()
        {
        ...
        public JsonResult Index()
        {
            for (var i = 0; i < 500; i++)
            {
                ...
                _logProvider.LogWarning(action[1], new List<KeyValuePair<string, string>>
                    {
